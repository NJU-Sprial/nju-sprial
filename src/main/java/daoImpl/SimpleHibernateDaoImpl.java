...
public class SimpleHibernateDaoImpl<T, PK extends Serializable> implements dao.SimpleHibernateDao<T, PK> {
     ...
     */
    public SimpleHibernateDaoImpl(final Class<T> entityClass) {
