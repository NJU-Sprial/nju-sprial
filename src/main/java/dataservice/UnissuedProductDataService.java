...
public interface UnissuedProductDataService {
     ...
     */
    ConceptualVO getConceptual(String username, String pname, String packageNumber);
     ...
     */
    boolean saveProductStrategy(ConceptualVO conceptualVO) throws ErrorParamException;
}
